...
describe("Triangle Test", () => {
    test('Selecting Triangle and Blue should create a blue triangle with white text', () => {
        const data = { 
            logoText: 'TXT', 
            logoTextColor: 'white', 
            logoShape: 'Triangle', 
...
describe("Square Test", () => {
    test('Selecting Square and Red should create a red square with yellow text', () => {
        const data = { 
            logoText: 'TXT', 
...
describe("Circle Test", () => {
    test('Selecting Circle and Yellow should create a yellow circle with black text', () => {
        const data = { 
            logoText: 'TXT', 
            logoTextColor: 'black', 
            logoShape: 'Circle', 
